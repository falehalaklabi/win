    ...
    <div class="container">
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto ">
                <img src="./images/faleh.jpeg" alt="">
                <h1 class="display-4 fw-normal">اربح مع فالح </h1>
            ...
            <!-- <li class="list-group-item">اتمنى للجميع التوفيق</li> -->
            <li class="list-group-item">تابع البث المباشر في حسابي في فيس بوك بالتاريخ المذكور اعلاه</li>
            <li class="list-group-item">راح افتح البث المباشر في حسابي في فيس بوك عباره عن اسئلة واجوبة حرة للجميع</li>
            <li class="list-group-item">خلال فتره التسجيل سيتم فتح صفحه التسجيل هنا حيث سنقوم بتسجيل الأسم الأول الأسم الأخير وايميلك</li>
...
//alert("JS");
var countDownDate = new Date("april 30, 2023 16:30:00").getTime();
